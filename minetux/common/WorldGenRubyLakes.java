                ...
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (i2 = 0; i2 < 8; ++i2)
                    {
                        ...
                        if (flag)
                        {
                            ...
                            if (i2 < 4 && !material.isSolid() && par1World.getBlockId(par3 + i1, par4 + i2, par5 + j2) != MineTux.BlockFluidRuby.blockID)
                            {
                                return false;
                            }
                        }
            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (i2 = 0; i2 < 8; ++i2)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + i1, par4 + i2, par5 + j2, i2 >= 4 ? 0 : MineTux.BlockFluidRuby.blockID, 0, 2);
                        }
                    }
                }
            }
