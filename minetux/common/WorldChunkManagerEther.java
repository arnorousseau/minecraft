...
public class WorldChunkManagerEther extends WorldChunkManager
{
	...
	protected WorldChunkManagerEther()
	{
	...
	{
		this();
		GenLayer[] agenlayer = GenLayerEther.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerEther(World world)
	{
