...
public class WorldGenVolcanoAsh extends WorldGenerator
{
        private int minableBlockId;

        private int numberOfBlocks;

        public WorldGenVolcanoAsh(int par1, int par2)
        {
            minableBlockId = par1;
            numberOfBlocks = par2;
        }
	                                ...
	                                for (int var41 = var33; var41 <= var36; ++var41)
	                                {
	                                        ...
	                                        if (var39 * var39 + var42 * var42 < 1.0D)
	                                        {
	                                                for (int var44 = var34; var44 <= var37; ++var44)
	                                                {
	                                                        ...
	                                                        if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && par1World.getBlockId(var38, var41, var44) == MineTux.BlockVolcano.blockID || par1World.getBlockId(var38, var41, var44) == Block.netherrack.blockID)
	                                                        {
