...
public class WorldGenSwampBiome extends WorldGenerator
{
    public WorldGenSwampBiome()
    {
    }
    ...
    {
        par1World.setBlockMetadataWithNotify(par2, par3, par4, Block.waterStill.blockID, par5);
