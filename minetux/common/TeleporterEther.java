...
public class TeleporterEther extends Teleporter
{
	...
	public TeleporterEther(WorldServer par1WorldServer)
	{
	...
	{
         if (this.worldServerInstance.provider.dimensionId == MineTux.ether_id)
         {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
	         ...
	         else
	         {
	                 for (k1 = l - short1; k1 <= l + short1; ++k1)
	                 {
	                         ...
	                         for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
	                         {
	                                 ...
	                                 {
	                                         /** change this block **/
	                                         if (this.worldServerInstance.getBlockId(k1, i2, l1) == Block.blockIron.blockID)
	                                         {
	                                                 /** change this block **/
	                                                 while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == Block.blockIron.blockID)
	                                                 {
	                                                         --i2;
	                                                 }
	         ...
	         if (d3 >= 0.0D)
	         {
	                 if (flag)
	                 {
                         this.destinationCoordinateCache.add(j1, new PortalEtherPosition(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
	                 ...
	                 int j2 = -1;
	                 /** change this block **/
	                 if (this.worldServerInstance.getBlockId(i - 1, j, k) == Block.blockIron.blockID)
	                 {
	                         j2 = 2;
	                 }
	                 /** change this block **/
	                 ...
	                 /** change this block **/
	                 if (this.worldServerInstance.getBlockId(i, j, k - 1) == Block.blockIron.blockID)
	                 {
	                         j2 = 3;
	                 }
	                 /** change this block **/
	    ...
	    for (k2 = 0; k2 < 4; ++k2)
	    {
	        for (i3 = 0; i3 < 4; ++i3)
	        {
	            for (l2 = -1; l2 < 4; ++l2)
	            {
	                ...
	                this.worldServerInstance.setBlock(k3, j3, i4, flag ?Block.blockIron.blockID : Block.blockIron.blockID, 0, 2);
	            }
	        }
	...
	private boolean invalidSpawn(int i2, int k2, int j2) {
      int id = this.worldServerInstance.getBlockId(i2 , k2, j2);
      return this.worldServerInstance.isAirBlock(i2 , k2, j2) || Block.blocksList[id] != null && Block.blocksList[id] != null && !Block.blocksList[id].isOpaqueCube();
	}
